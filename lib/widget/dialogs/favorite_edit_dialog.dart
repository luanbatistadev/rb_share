...
import 'package:rb_share/widget/dialogs/favorite_delete_dialog.dart';
...
class FavoriteEditDialog extends StatefulWidget {
  ...
  const FavoriteEditDialog({super.key, this.favorite});
  ...
  void initState() {
    ...
    ensureRef((ref) {
      _portController.text =
          widget.favorite?.port.toString() ?? ref.read(settingsProvider).port.toString();
    });
  }
              ...
              onPressed: () async {
                ...
                if (mounted && result == true) {
                  await context.ref.redux(favoritesProvider).dispatchAsync(
                      RemoveFavoriteAction(deviceFingerprint: widget.favorite!.fingerprint),);
                  if (mounted) {
                    context.pop();
                  }
                }
              ...
              : () async {
                  ...
                  if (widget.favorite != null) {
                    ...
                    await ref
                        ...
                        .dispatchAsync(UpdateFavoriteAction(existingFavorite.copyWith(
