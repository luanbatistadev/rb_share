  ...
  Widget build(BuildContext context) {
    return Shortcuts(
      shortcuts: {
        ...
        // https://github.com/rbshare/rbshare/issues/194
        ...
        if (checkPlatform([TargetPlatform.macOS]))
          LogicalKeySet(LogicalKeyboardKey.meta, LogicalKeyboardKey.keyW): _CloseWindowIntent(),
      ...
      child: Actions(
        actions: {
          ...
          _PopPageIntent:
              CallbackAction(onInvoke: (_) async => Navigator.of(Routerino.context).maybePop()),
          _PasteIntent: CallbackAction(
            onInvoke: (_) async {
              await context.ref.dispatchAsync(
