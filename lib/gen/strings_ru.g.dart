...
class _StringsReceiveOptionsPageRu extends _StringsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(Папка RBShare)';
  @override
...
class _StringsWebSharePageRu extends _StringsWebSharePageEn {
  ...
  String get encryptionHint =>
      'RBShare использует самоподписанный сертификат. Вам необходимо принять его в браузере.';
  @override
...
class _StringsAboutPageRu extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'О RBShare';
  @override
  List<String> get description => [
        'RBShare — это бесплатное приложение с открытым исходным кодом, которое позволяет вам безопасно обмениваться файлами и сообщениями с находящимися поблизости устройствами через локальную сеть без необходимости подключения к Интернету.',
...
class _StringsDonationPageRu extends _StringsDonationPageEn {
  ...
  @override
  String get info =>
      'RBShare бесплатен, имеет открытый исходный код и не содержит рекламы. Если вам нравится приложение, вы можете поддержать его разработку пожертвованием.';
  @override
...
class _StringsDialogsRu extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsEncryptionDisabledNoticeRu encryptionDisabledNotice =
  ...
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedRu localNetworkUnauthorized =
...
class _StringsTrayRu extends _StringsTrayEn {
  ...
  @override
  String get close => 'Выйти из RBShare';
}
...
class _StringsSettingsTabOtherRu extends _StringsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Поддержать RBShare';
  @override
...
class _StringsDialogsLocalNetworkUnauthorizedRu extends _StringsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'RBShare не может найти другие устройства без разрешения на сканирование локальной сети. Пожалуйста, предоставьте это разрешение в настройках.';
  @override
...
class _StringsDialogsSendModeHelpRu extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Получатели, у которых не установлен RBShare, могут загрузить выбранные файлы открыв ссылку в своем браузере.';
}
