...
class _StringsWebSharePageEn {
  ...
  String get encryptionHint =>
      'RBShare uses a self-signed certificate. You need to accept it in your browser.';
...
class _StringsAboutPageEn {
  ...
  // Translations
  String get title => 'About RBShare';
  List<String> get description => [
        'RBShare is a free, open-source app that allows you to securely share files and messages with nearby devices over your local network without needing an internet connection.',
...
class _StringsDonationPageEn {
  ...
  String get info =>
      'RBShare is free, open-source and without any ads. If you like the app, you can support the development with a donation.';
...
class _StringsDialogsEn {
  ...
  late final _StringsDialogsEncryptionDisabledNoticeEn encryptionDisabledNotice =
  ...
  late final _StringsDialogsLocalNetworkUnauthorizedEn localNetworkUnauthorized =
...
class _StringsSettingsTabOtherEn {
  ...
  String get support => 'Support RBShare';
...
class _StringsDialogsSendModeHelpEn {
  ...
  String get link =>
      'Recipients who do not have RBShare installed can download the selected files by opening the link in their browser.';
}
