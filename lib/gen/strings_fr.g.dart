...
class _StringsWebSharePageFr extends _StringsWebSharePageEn {
  ...
  String get encryptionHint =>
      'RBShare utilise un certificat auto-signé. Vous devez l\'accepter dans le navigateur.';
  @override
...
class _StringsAboutPageFr extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'A propos de RBShare';
  @override
  List<String> get description => [
        'RBShare est un logiciel gratuit et open-source qui vous permet de partager de manière sécurisée des fichers et des messages avec d\'autres appareils sur votre réseau local, sans même avoir besoin d\'une connexion à internet.',
        'RBShare est disponible sur Android, iOS, macOS, Windows et Linux. Vous pouvez accéder à ces téléchargements sur la page officielle.',
      ];
  @override
...
class _StringsDonationPageFr extends _StringsDonationPageEn {
  ...
  @override
  String get info =>
      'RBShare est gratuit, open-source and sans aucune pub. Si vous aimez ce logiciel, vous pouvez faire un don pour supporter son développement.';
  @override
...
class _StringsDialogsFr extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsEncryptionDisabledNoticeFr encryptionDisabledNotice =
  ...
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedFr localNetworkUnauthorized =
...
class _StringsTrayFr extends _StringsTrayEn {
  ...
  @override
  String get close => 'Quitter RBShare';
}
...
class _StringsSettingsTabOtherFr extends _StringsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Supporter RBShare';
  @override
...
class _StringsDialogsLocalNetworkUnauthorizedFr extends _StringsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'RBShare ne peut pas trouver d\'autres appareils sans la permission de scanner votre réseau local. Veuillez autoriser cette permission à RBShare dans les paramètres.';
  @override
...
class _StringsDialogsSendModeHelpFr extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Les récipients n\'ayant pas RBShare installé peuvent télécharger les fichiers sélectionnés en ouvrant le lien dans leur navigateur.';
}
