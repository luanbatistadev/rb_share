...
class _StringsWebSharePageZhTw extends _StringsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'RBShare 使用自簽名憑證。您需要在瀏覽器中接受它。';
  @override
...
class _StringsAboutPageZhTw extends _StringsAboutPageEn {
  ...
  List<String> get description => [
        'RBShare 是一款免費的開源應用程式，可讓您透過區域網路與鄰近的裝置安全的共享檔案和訊息，無需網際網路連線。',
...
class _StringsDonationPageZhTw extends _StringsDonationPageEn {
  ...
  String get title => '贊助';
  @override
  String get info => 'RBShare 是免費、開源且沒有任何廣告的。如果您喜歡此應用程式，您可以透過捐贈來支持開發。';
  @override
...
class _StringsDialogsZhTw extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsEncryptionDisabledNoticeZhTw encryptionDisabledNotice =
  ...
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedZhTw localNetworkUnauthorized =
...
class _StringsDialogsLocalNetworkUnauthorizedZhTw
  ...
  @override
  String get description => '在未取得掃描區域網路權限的狀況下 RBShare 無法找到其他裝置，請在設定中授予此權限。';
  @override
...
class _StringsDialogsSendModeHelpZhTw extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link => '未安裝 RBShare 的接收者可以透過在瀏覽器開啟連結以下載選取的檔案.';
}
