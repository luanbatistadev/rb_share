...
class _StringsReceiveOptionsPageTh extends _StringsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(โฟลเดอร์ของ RBShare)';
  @override
...
class _StringsWebSharePageTh extends _StringsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'RBShare ใช้ใบรับรองที่ลงนามด้วยตัวเอง คุณต้องยอมรับในเบราว์เซอร์';
  @override
...
class _StringsAboutPageTh extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'เกี่ยวกับ RBShare';
  @override
  List<String> get description => [
        'RBShare เป็นแอปโอเพ่นซอร์สฟรีที่ช่วยให้คุณแบ่งปันไฟล์และข้อความอย่างปลอดภัยกับอุปกรณ์ใกล้เคียงผ่านเครือข่ายท้องถิ่นของคุณโดยไม่จำเป็นต้องเชื่อมต่ออินเทอร์เน็ต',
...
class _StringsDonationPageTh extends _StringsDonationPageEn {
  ...
  @override
  String get info =>
      'RBShare เป็นบริการโอเพ่นซอร์สฟรีและไม่มีโฆษณา หากคุณชอบแอพนี้ คุณสามารถสนับสนุนการพัฒนาด้วยการบริจาค';
  @override
...
class _StringsDialogsTh extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsEncryptionDisabledNoticeTh encryptionDisabledNotice =
  ...
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedTh localNetworkUnauthorized =
...
class _StringsTrayTh extends _StringsTrayEn {
  ...
  @override
  String get close => 'ออกจาก RBShare';
}
...
class _StringsSettingsTabOtherTh extends _StringsSettingsTabOtherEn {
  ...
  @override
  String get support => 'สนับสนุน RBShare';
  @override
...
class _StringsDialogsLocalNetworkUnauthorizedTh extends _StringsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'RBShare ไม่สามารถค้นหาอุปกรณ์อื่นได้หากไม่มีสิทธิ์ในการสแกนเครือข่ายท้องถิ่น โปรดอนุญาตสิทธิ์นี้ในการตั้งค่า';
  @override
...
class _StringsDialogsSendModeHelpTh extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'ผู้รับที่ไม่ได้ติดตั้ง RBShare สามารถดาวน์โหลดไฟล์ที่เลือกได้โดยเปิดลิงก์ในเบราว์เซอร์';
}
