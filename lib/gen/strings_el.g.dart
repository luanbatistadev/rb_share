...
class _StringsReceiveOptionsPageEl extends _StringsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(Φάκελος RBShare)';
  @override
...
class _StringsWebSharePageEl extends _StringsWebSharePageEn {
  ...
  String get encryptionHint =>
      'Το RBShare χρησιμοποιεί αυτο-υπογεγραμμένο πιστοποιητικό. Χρειάζεται να το αποθεχτείτε στον φυλλομετρητή.';
  @override
...
class _StringsAboutPageEl extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Σχετικά με το RBShare';
  @override
  List<String> get description => [
        'Το RBShare είναι μια δωρεάν εφαρμογή ανοιχτού κώδικα που σας επιτρέπει να μοιράζεστε με ασφάλεια αρχεία και μηνύματα με κοντινές συσκευές μέσω του τοπικού σας δικτύου χωρίς να χρειάζεστε σύνδεση στο διαδίκτυο.',
...
class _StringsDialogsEl extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsEncryptionDisabledNoticeEl encryptionDisabledNotice =
  ...
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedEl localNetworkUnauthorized =
...
class _StringsTrayEl extends _StringsTrayEn {
  ...
  @override
  String get close => 'Έξοδος από το RBShare';
}
...
class _StringsDonationPageEl extends _StringsDonationPageEn {
  ...
  @override
  String get info =>
      'Το RBShare είναι δωρεάν, ανοιχτού κώδικα και χωρίς διαφημίσεις. Εάν σας αρέσει η εφαρμογή, μπορείτε να υποστηρίξετε την ανάπτυξή της με μια δωρεά.';
  @override
...
class _StringsSettingsTabOtherEl extends _StringsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Υποστηρίξτε το RBShare';
  @override
...
class _StringsDialogsLocalNetworkUnauthorizedEl extends _StringsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'RBShare can\'t find other devices without having the permission to scan the local network. Please grant this permission in the settings.';
  @override
...
class _StringsDialogsSendModeHelpEl extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Οι παραλήπτες που δεν έχουν εγκαταστήσει το RBShare μπορούν να πραγματοποιήσουν λήψη των επιλεγμένων αρχείων ανοίγοντας τον σύνδεσμο στον φυλλομετρητή τους.';
}
