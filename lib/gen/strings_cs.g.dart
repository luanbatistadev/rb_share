...
class _StringsWebSharePageCs extends _StringsWebSharePageEn {
  ...
  String get encryptionHint =>
      'RBShare používá self-signed certifikát. Musíte ho přijmout ve vašem prohlížeči.';
  @override
...
class _StringsAboutPageCs extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'O aplikaci RBShare';
  @override
  List<String> get description => [
        'RBShare je bezplatná aplikace s otevřeným zdrojovým kódem, která vám umožňuje bezpečně sdílet soubory a zprávy s okolními zařízeními přes vaši místní síť, aniž byste potřebovali připojení k internetu.',
...
class _StringsDonationPageCs extends _StringsDonationPageEn {
  ...
  @override
  String get info =>
      'RBShare je zdarma, open source a bez reklam. Pokud se vám aplikace líbí, můžete její vývoj podpořit darem.';
  @override
...
class _StringsDialogsCs extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsEncryptionDisabledNoticeCs encryptionDisabledNotice =
  ...
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedCs localNetworkUnauthorized =
...
class _StringsTrayCs extends _StringsTrayEn {
  ...
  @override
  String get close => 'Ukončit RBShare';
}
...
class _StringsSettingsTabOtherCs extends _StringsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Podpora RBShare';
  @override
...
class _StringsDialogsLocalNetworkUnauthorizedCs extends _StringsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'RBShare nemůže najít jiná zařízení, aniž by měl oprávnění skenovat místní síť. Udělte prosím toto oprávnění v nastavení.';
  @override
...
class _StringsDialogsSendModeHelpCs extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Příjemci, kteří nemají nainstalovaný RBShare, si mohou vybrané soubory stáhnout otevřením odkazu ve svém prohlížeči.';
}
