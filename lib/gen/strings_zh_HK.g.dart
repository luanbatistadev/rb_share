...
class _StringsReceiveOptionsPageZhHk extends _StringsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '（RBShare 資料夾）';
  @override
...
class _StringsWebSharePageZhHk extends _StringsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'RBShare 用嘅係自我簽署憑證。麻煩你喺瀏覽器度允許咗佢。';
  @override
...
class _StringsAboutPageZhHk extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => '關於 RBShare';
  @override
  List<String> get description => [
        'RBShare 係一款免費嘅開源應用程式，佢可以透過區域網路幫你安全噉將檔案同訊息分享畀附近嘅裝置，全程無需互聯網連線。',
...
class _StringsDonationPageZhHk extends _StringsDonationPageEn {
  ...
  @override
  String get info => 'RBShare 唔單只免費、開源，仲係冇廣告添㗎！如果你鍾意呢個 app，不妨捐款贊助我哋開發？';
  @override
...
class _StringsDialogsZhHk extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsEncryptionDisabledNoticeZhHk encryptionDisabledNotice =
  ...
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedZhHk localNetworkUnauthorized =
...
class _StringsDialogsLocalNetworkUnauthorizedZhHk
  ...
  @override
  String get description => '喺冇權掃描區域網路嘅情況下 RBShare 唔會偵測到其他裝置。麻煩你喺系統設定開返呢個權限。';
  @override
...
class _StringsDialogsSendModeHelpZhHk extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link => '冇裝 RBShare 嘅裝置可以透過條 link 嚟 download 返揀選嘅項目。';
}
