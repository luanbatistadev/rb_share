...
class _StringsReceiveOptionsPageJa extends _StringsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(RBShare フォルダー)';
  @override
...
class _StringsWebSharePageJa extends _StringsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'RBShareは自己署名証明書を使用しているため、ブラウザーで証明書を許可する必要があります。';
  @override
...
class _StringsAboutPageJa extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'RBShareについて';
  @override
  List<String> get description => [
        'RBShareは無料のオープンソースアプリで、インターネットに接続することなく、ローカルネットワーク経由で近くにあるデバイスとファイルやメッセージを安全に共有することができます。',
...
class _StringsDonationPageJa extends _StringsDonationPageEn {
  ...
  String get title => '寄付';
  @override
  String get info => 'RBShareは無料かつオープンソースで、広告を一切含みません。もしアプリを気に入っていただけたら、寄付で開発を支援することができます。';
  @override
...
class _StringsDialogsJa extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsEncryptionDisabledNoticeJa encryptionDisabledNotice =
  ...
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedJa localNetworkUnauthorized =
...
class _StringsDialogsLocalNetworkUnauthorizedJa extends _StringsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'ローカルネットワークをスキャンする権限がないと、RBShareは他のデバイスを見つけることができません。設定よりこの権限を付与してください。';
  @override
...
class _StringsDialogsSendModeHelpJa extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'RBShareをインストールしていない受信者でも、ブラウザでリンクを開くことで選択したファイルをダウンロードできます。';
}
