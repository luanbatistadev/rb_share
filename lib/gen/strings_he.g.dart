...
class _StringsReceiveOptionsPageHe extends _StringsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(תיקיית RBShare)';
  @override
...
class _StringsWebSharePageHe extends _StringsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'RBShare משתמש בתעודה עצמית. עליך לאשר אותה בדפדפן.';
  @override
...
class _StringsAboutPageHe extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'אודות RBShare';
  @override
  List<String> get description => [
        'RBShare היא אפליקציית קוד פתוח חינמית המאפשרת לשתף קבצים והודעות בצורה מאובטחת עם מכשירים קרובים דרך הרשת המקומית מבלי להזדקק לחיבור לאינטרנט.',
...
class _StringsDonationPageHe extends _StringsDonationPageEn {
  ...
  @override
  String get info =>
      'אפליקציית RBShare היא חינמית, קוד פתוח וללא פרסומות. אם אתה אוהב את האפליקציה, אתה יכול לתמוך בפיתוח באמצעות תרומה.';
  @override
...
class _StringsDialogsHe extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsEncryptionDisabledNoticeHe encryptionDisabledNotice =
  ...
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedHe localNetworkUnauthorized =
...
class _StringsSettingsTabOtherHe extends _StringsSettingsTabOtherEn {
  ...
  @override
  String get support => 'תמיכה ב-RBShare';
  @override
...
class _StringsDialogsLocalNetworkUnauthorizedHe extends _StringsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'ל־RBShare אין אפשרות למצוא מכשירים אחרים ללא הרשאה לסריקת הרשת המקומית. אנא הענק את ההרשאה הזו בהגדרות.';
  @override
...
class _StringsDialogsSendModeHelpHe extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'מקבלים ש-RBShare לא מותקן אצלם יוכלו להוריד את הקבצים שנבחרו על ידי פתיחת הקישור בדפדפן שלהם.';
}
