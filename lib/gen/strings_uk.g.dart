...
class _StringsSendTabUk extends _StringsSendTabEn {
  ...
  @override
  String get help =>
      'Будь ласка, переконайтесь, що одержувач перебуває в тій же ж Wi-Fi мережі, що і відправник.';
  @override
...
class _StringsReceiveOptionsPageUk extends _StringsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(Тека RBShare)';
  @override
...
class _StringsWebSharePageUk extends _StringsWebSharePageEn {
  ...
  String get encryptionHint =>
      'RBShare використовує самопідписаний сертифікат. Вам потрібно прийняти його в браузері.';
  @override
...
class _StringsAboutPageUk extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Про RBShare';
  @override
  List<String> get description => [
        'RBShare — це безкоштовний додаток з відкритим вихідним кодом, який дозволяє безпечно обмінюватися файлами та повідомленнями з пристроями поблизу через локальну мережу без підключення до Інтернету.',
...
class _StringsDonationPageUk extends _StringsDonationPageEn {
  ...
  @override
  String get info =>
      'RBShare є безкоштовним, із відкритим вихідним кодом і без реклами. Якщо вам подобається додаток, ви можете підтримати його розробку пожертвою.';
  @override
...
class _StringsDialogsUk extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsEncryptionDisabledNoticeUk encryptionDisabledNotice =
  ...
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedUk localNetworkUnauthorized =
...
class _StringsTrayUk extends _StringsTrayEn {
  ...
  @override
  String get close => 'Вихід із RBShare';
}
...
class _StringsSettingsTabOtherUk extends _StringsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Підтримати RBShare';
  @override
...
class _StringsDialogsLocalNetworkUnauthorizedUk extends _StringsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'RBShare не може знайти інші пристрої, не маючи дозволу на сканування в локальній мережі. Надайте цей дозвіл у налаштуваннях.';
  @override
...
class _StringsDialogsSendModeHelpUk extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Одержувачі, у яких не встановлений RBShare, можуть завантажити вибрані файли відкривши посилання у своєму браузері.';
}
