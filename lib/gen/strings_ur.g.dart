...
class _StringsWebSharePageUr extends _StringsWebSharePageEn {
  ...
  String get encryptionHint =>
      'RBShare براؤزر میں استعمال کرنے کیلئے آپ کوخود سائن کردہ سرٹیفکیٹ قبول کرنا ہوگا۔';
  @override
...
class _StringsAboutPageUr extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'کے بارے میں RBShare';
}
...
class _StringsDialogsUr extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsEncryptionDisabledNoticeUr encryptionDisabledNotice =
  ...
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedUr localNetworkUnauthorized =
...
class _StringsTrayUr extends _StringsTrayEn {
  ...
  @override
  String get close => 'چھوڑو RBShare';
}
...
class _StringsDialogsLocalNetworkUnauthorizedUr extends _StringsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'لوکل نیٹ ورک کا سکین کرنے کی اجازت کے بغیر RBShare، دیگر ڈیوائسز تلاش نہیں کرسکتا ہے۔ براہ کرم ترتیبات میں اس اجازت کو منظور کریں۔';
  @override
...
class _StringsDialogsSendModeHelpUr extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'RBShare نصب نہیں ہونے والے رسیورز منتخب شدہ فائلز کو لنک اپنے براؤزر میں کھولنے سے ڈاؤن لوڈ کر سکتے ہیں۔';
}
