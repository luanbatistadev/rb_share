...
class _StringsWebSharePageBn extends _StringsWebSharePageEn {
  ...
  String get encryptionHint =>
      'RBShare একটি স্ব-স্বাক্ষরিত শংসাপত্র ব্যবহার করে। আপনাকে ব্রাউজারে এটি গ্রহণ করতে হবে।';
  @override
...
class _StringsAboutPageBn extends _StringsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'RBShare সম্পর্কে';
  @override
  List<String> get description => [
        'RBShare হল একটি বিনামূল্যের, ওপেন সোর্স অ্যাপ যা আপনাকে ইন্টারনেট সংযোগের প্রয়োজন ছাড়াই আপনার স্থানীয় নেটওয়ার্কে কাছাকাছি ডিভাইসগুলির সাথে ফাইল এবং বার্তাগুলিকে নিরাপদে ভাগ করতে দেয়৷',
...
class _StringsDonationPageBn extends _StringsDonationPageEn {
  ...
  @override
  String get info =>
      'RBShare বিনামূল্যে, ওপেন সোর্স এবং কোনো বিজ্ঞাপন ছাড়াই। আপনি যদি অ্যাপটি পছন্দ করেন তবে আপনি একটি অনুদান দিয়ে বিকাশকে সমর্থন করতে পারেন।';
  @override
...
class _StringsDialogsBn extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsEncryptionDisabledNoticeBn encryptionDisabledNotice =
  ...
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedBn localNetworkUnauthorized =
...
class _StringsTrayBn extends _StringsTrayEn {
  ...
  @override
  String get close => 'RBShare থেকে প্রস্থান করুন';
}
...
class _StringsDialogsLocalNetworkUnauthorizedBn extends _StringsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'স্থানীয় নেটওয়ার্ক স্ক্যান করার অনুমতি ছাড়া RBShare অন্য ডিভাইস খুঁজে পায় না। অনুগ্রহ করে সেটিংসে এই অনুমতি দিন.';
  @override
...
class _StringsDialogsSendModeHelpBn extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'যাদের কাছে RBShare ইনস্টল নেই তারা তাদের ব্রাউজারে লিঙ্কটি খুলে নির্বাচিত ফাইলগুলি ডাউনলোড করতে পারেন৷';
}
