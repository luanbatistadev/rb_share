...
import 'package:rb_share/util/native/cmd_helper.dart';
import 'package:rb_share/util/native/platform_check.dart';
import 'package:rb_share/widget/custom_icon_button.dart';
import 'package:rb_share/widget/dialogs/not_available_on_platform_dialog.dart';
            ...
            primaryButton: _FixButton(
              ...
              onTapMap: {
                TargetPlatform.windows: _CommandFixAction(
                  ...
                  commands: [
                    'netsh advfirewall firewall add rule name="RBShare" dir=in action=allow protocol=TCP localport=${settings.port}',
                    'netsh advfirewall firewall add rule name="RBShare" dir=in action=allow protocol=UDP localport=${settings.port}',
                  ],
                ),
              },
            ),
          ...
          child: Column(
            ...
            children: [
              ...
              if (widget.primaryButton != null) ...[
                ...
                AnimatedCrossFade(
                  crossFadeState:
                      _showCommands ? CrossFadeState.showSecond : CrossFadeState.showFirst,
