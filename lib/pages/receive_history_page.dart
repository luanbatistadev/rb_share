...
import 'package:rb_share/widget/dialogs/file_info_dialog.dart';
import 'package:rb_share/widget/dialogs/history_clear_dialog.dart';
              ...
              return Padding(
                ...
                child: InkWell(
                  ...
                  onTap: entry.path != null
                      ? () async => _openFile(context, entry, context.redux(receiveHistoryProvider))
                      : null,
                  child: Row(
