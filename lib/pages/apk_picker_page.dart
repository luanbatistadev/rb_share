...
import 'package:rb_share/provider/apk_provider.dart';
...
import 'package:rb_share/widget/sliver/sliver_pinned_header.dart';
...
class _ApkPickerPageState extends State<ApkPickerPage> with Refena {
  ...
  void _pickApp(Application app) {
    ...
    ref.redux(selectedSendingFilesProvider).dispatchAsync(
          ...
          PopupMenuButton(itemBuilder: (context) {
            ...
            switch (value) {
              case 0:
                ...
                break;
              case 1:
                ref.notifier(apkSearchParamProvider).setState(
                    (old) => old.copyWith(onlyAppsWithLaunchIntent: !old.onlyAppsWithLaunchIntent),);
                break;
            }
          },),
        ],
