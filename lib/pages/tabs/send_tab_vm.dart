...
import 'package:rb_share/pages/web_send_page.dart';
...
import 'package:rb_share/provider/network/scan_facade.dart';
...
import 'package:rb_share/widget/dialogs/address_input_dialog.dart';
import 'package:rb_share/widget/dialogs/favorite_dialog.dart';
import 'package:rb_share/widget/dialogs/no_files_dialog.dart';
    ...
    onToggleFavorite: (device) async {
      ...
      if (isFavorite) {
        await ref
            ...
            .dispatchAsync(RemoveFavoriteAction(deviceFingerprint: device.fingerprint));
      } else {
        await ref
            .redux(favoritesProvider)
    ...
    onTapDeviceMultiSend: (context, device) async {
      ...
      if (session != null) {
        if (session.status == SessionStatus.waiting) {
          ...
          await context.push(
            () => SendPage(
                showAppBar: true, closeSessionOnClose: false, sessionId: session.sessionId,),
