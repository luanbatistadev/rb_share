...
import 'package:rb_share/pages/about/about_page.dart';
import 'package:rb_share/pages/changelog_page.dart';
import 'package:rb_share/pages/donation/donation_page.dart';
import 'package:rb_share/pages/language_page.dart';
import 'package:rb_share/pages/tabs/settings_tab_controller.dart';
import 'package:rb_share/provider/settings_provider.dart';
import 'package:rb_share/provider/version_provider.dart';
import 'package:rb_share/theme.dart';
import 'package:rb_share/util/device_type_ext.dart';
import 'package:rb_share/util/native/autostart_helper.dart';
import 'package:rb_share/util/native/pick_directory_path.dart';
import 'package:rb_share/util/native/platform_check.dart';
import 'package:rb_share/widget/custom_dropdown_button.dart';
import 'package:rb_share/widget/dialogs/encryption_disabled_notice.dart';
          ...
          children: [
            ...
            _SettingsSection(
              ...
              children: [
                ...
                if (checkPlatformIsDesktop()) ...[
                  /// Wayland does window position handling, so there's no need for it. See [https://github.com/rbshare/rbshare/issues/544]
            ...
            _SettingsSection(
              ...
              children: [
                ...
                AnimatedCrossFade(
                  crossFadeState: vm.settings.multicastGroup != defaultMulticastGroup
                      ? CrossFadeState.showSecond
                      : CrossFadeState.showFirst,
                  duration: const Duration(milliseconds: 200),
                  alignment: Alignment.topLeft,
                  ...
                  secondChild: Padding(
                    ...
                    child: Text(
                      t.settingsTab.network
                          .multicastGroupWarning(defaultMulticast: defaultMulticastGroup),
                      style: const TextStyle(color: Colors.grey),
                    ),
                  ),
                ),
            ...
            _SettingsSection(
              ...
              children: [
                ...
                _ButtonEntry(
                  ...
                  onTap: () async {
                    await launchUrl(
                      Uri.parse('https://rbshare.org/#/privacy'),
            ...
            const RBShareLogo(withText: true),
