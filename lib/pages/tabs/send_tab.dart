...
import 'package:rb_share/pages/troubleshoot_page.dart';
...
import 'package:rb_share/widget/dialogs/send_mode_help_dialog.dart';
...
class ScanButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final (scanningFavorites, scanningIps) = context.ref
        .watch(nearbyDevicesProvider.select((s) => (s.runningFavoriteScan, s.runningIps)));
    final animations = context.ref.watch(animationProvider);

    final spinning = (scanningFavorites || scanningIps.isNotEmpty) && animations;
    final iconColor =
        !animations && scanningIps.isNotEmpty ? Theme.of(context).colorScheme.warning : null;
