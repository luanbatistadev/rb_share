...
import 'package:rb_share/widget/dialogs/qr_dialog.dart';
...
class WebSendPage extends StatefulWidget {
  ...
  const WebSendPage(this.files, {super.key});
              ...
              return Column(
                ...
                children: [
                  if (_stateEnum == _ServerState.initializing ||
                    ...
                    Center(
                      child:
                          Text(t.webSharePage.error, style: Theme.of(context).textTheme.titleLarge),
                    ),
                    const SizedBox(height: 10),
                    Center(
