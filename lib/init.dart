...
import 'package:rb_share/provider/app_arguments_provider.dart';
import 'package:rb_share/provider/device_info_provider.dart';
import 'package:rb_share/provider/dio_provider.dart';
import 'package:rb_share/provider/network/nearby_devices_provider.dart';
...
// [FOSS_REMOVE_START]
import 'package:rb_share/provider/purchase_provider.dart';
// [FOSS_REMOVE_END]
import 'package:rb_share/provider/selection/selected_sending_files_provider.dart';
import 'package:rb_share/provider/tv_provider.dart';
import 'package:rb_share/provider/window_dimensions_provider.dart';
import 'package:rb_share/refena.dart';
import 'package:rb_share/theme.dart';
import 'package:rb_share/util/api_route_builder.dart';
import 'package:rb_share/util/i18n.dart';
import 'package:rb_share/util/logger.dart';
import 'package:rb_share/util/native/cache_helper.dart';
import 'package:rb_share/util/native/cross_file_converters.dart';
import 'package:rb_share/util/native/device_info_helper.dart';
import 'package:rb_share/util/native/platform_check.dart';
import 'package:rb_share/util/native/tray_helper.dart';
...
Future<RefenaContainer> preInit(List<String> args) async {
  ...
  if (checkPlatformIsDesktop()) {
    ...
    final dio =
        createDio(const Duration(milliseconds: 100), persistenceService.getSecurityContext());
...
Future<void> postInit(
    BuildContext context, Ref ref, bool appStart, void Function(int) goToPage,) async {
...
class _HandleShareIntentAction extends AsyncGlobalAction {
  ...
  Future<void> reduce() async {
    ...
    await ref.redux(selectedSendingFilesProvider).dispatchAsync(AddFilesAction(
          files: payload.attachments?.where((a) => a != null).cast<SharedAttachment>() ??
              <SharedAttachment>[],
