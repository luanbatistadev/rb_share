...
import 'package:rb_share/src/core/utils/native/file_picker.dart';
import 'package:rb_share/src/core/widgets/big_button.dart';
import 'package:rb_share/src/core/widgets/custom_icon_button.dart';
import 'package:rb_share/src/core/widgets/list_tile/device_placeholder_list_tile.dart';
import 'package:rb_share/src/core/widgets/rotating_widget.dart';
import 'package:rb_share/src/modules/send/local_ips/local_ip_controller.dart';
...
class _SendTabState extends State<SendTab> {
  final LocalIpsController _localIpsController = LocalIpsController();
  @override
  void initState() {
    super.initState();
    _localIpsController.getLocalIps();
  }
      ...
      children: [
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('t.sendTab.selection.files(files: vm.selectedFiles.length)'),
                  const Text(
                  ...
                  Row(
                    ...
                    children: [
                      TextButton(
                        ...
                        child: const Text('t.general.edit'),
                      ),
                      ...
                      ElevatedButton.icon(
                        ...
                        label: const Text('t.general.add'),
                      ),
                    ],
                  ),
                ],
        ...
        Row(
          children: [
            ...
            const SizedBox(width: 10),
            AnimatedBuilder(
              animation: _localIpsController,
              builder: (context, child) {
                final ips = _localIpsController.localIps;
                return _ScanButton(
                  ips: ips,
                );
              },
        ...
        if (true)
          const Padding(
            padding:
                EdgeInsets.only(bottom: 10, left: _horizontalPadding, right: _horizontalPadding),
            child: Opacity(
              opacity: 0.3,
