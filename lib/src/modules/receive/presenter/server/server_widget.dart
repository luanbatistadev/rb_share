...
import 'package:rb_share/src/modules/receive/presenter/server/qr_popup.dart';
...
class _ServerWidgetState extends State<ServerWidget> {
  ...
  _buildStartHostingButton(isServerStarted) => FloatingActionButton.extended(
        backgroundColor: isServerStarted ? Colors.redAccent : Theme.of(context).colorScheme.primaryContainer,
