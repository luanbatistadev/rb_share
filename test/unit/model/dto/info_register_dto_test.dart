...
void main() {
  MapperContainer.globals.use(InfoRegisterDtoMapper.ensureInitialized());

  group('parse InfoRegisterDto', () {
  ...
  group('serialize InfoRegisterDto', () {
    test('should serialize v2 data', () {
      const dto = InfoRegisterDto(
        alias: 'Test Device',
        version: '2.0',
        deviceModel: 'iPhone',
